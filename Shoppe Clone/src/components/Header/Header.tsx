    ...
    return (
        <div className='pb-5 pt-2 bg-[linear-gradient(-180deg,#f53d2d,#f63)] text-white text-sm'>
            <div className='container'>
                <NavHeader />
                <div className='grid grid-cols-12 mt-4 items-end mx-4'>
                    <Link to='/' className='col-span-2' aria-label='shoppeLogo'>
                        <svg viewBox='0 0 192 65' className='h-12 fill-white mx-auto'>
                            <g fillRule='evenodd'>
                    ...
                    <form className='col-span-9' onSubmit={onSubmitSearch}>
                        <div className='bg-white rounded-sm p-1 flex'>
                            <input
                                ...
                                {...register('name')}
                            />
                            <button className='rounded-sm py-2 px-6 flex-shrink-0 bg-orange hover:opacity-90' id='searchButton'>
                                <svg
                    ...
                    <div className='cols-span-1 justify-self-end'>
                        <PopOver
                            content={
                                <div className='bg-white relative shadow-md rounded-sm border border-gray-200 max-w-[400px] min-w-[350px] text-sm'>
                                    {purchaseInCartData && purchaseInCartData.length !== 0 ? (<div className='p-2'>
                        ...
                        >
                            <Link to={path.home} className='relative' aria-label='cartLogo'>
                                <svg
                                    xmlns='http://www.w3.org/2000/svg'
                                    fill='none'
                                    viewBox='0 0 24 24'
                                ...
                                {purchaseInCartData && purchaseInCartData.length > 0 && <span className='absolute top-[-7px] left-[17px] rounded-full bg-white px-[10px] text-sm text-orange'>{purchaseInCartData?.length}</span>}
